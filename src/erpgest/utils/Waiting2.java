...
public class Waiting2 extends javax.swing.JDialog {

    MainFrame frame;

    public Waiting2(MainFrame frame) {
    ...
    public Waiting2(MainFrame frame, JDialog dialog) {
    ...
    public Waiting2(MainFrame frame, JDialog dialog, String messaqe) {
    ...
    public Waiting2(MainFrame frame, JDialog dialog, String messaqe, boolean bool) {
    ...
    private void initComponents() {
        ...
        loadingLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lidomatic/images/load.gif"))); // NOI18N
