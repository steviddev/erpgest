 ...
 */
public class JDialogEsploraDoc extends javax.swing.JDialog {
    
  DefaultMutableTreeNode root;    
    
    /**
     * Creates new form JDialogEsploraDoc
     */
    
    
    public JDialogEsploraDoc(MainFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        CreateChildNodes ccn = 
                new CreateChildNodes(new File("./Documenti/"), root);
        ccn.run();
        tree.setVisible(true);
        model.reload(root);        
  ...
  public void getList(DefaultMutableTreeNode node, File f) {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(70, 50, 370, 440);
        ...
        jButton1.setBounds(540, 90, 74, 31);
